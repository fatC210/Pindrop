...
export function extractPlaceHierarchy(
  ...
  const cityLevelName = firstDefined(address.city, address.municipality);
  const settlementName = firstDefined(address.town, address.village, address.hamlet);
  ...
  const regionName = firstDistinct(
    [cityName],
    localityName,
    cityLevelName ? settlementName : undefined,
    cityLevelName ? countyName : undefined,
    cityName === settlementName ? countyName : undefined,
    cityName === settlementName ? adminLevelName : undefined,
